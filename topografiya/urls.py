...
urlpatterns = [
    ...
    re_path(r'^program_work_save_edits$', views.program_work_save_edits, name='program_work_save_edits'),
    re_path(r'^sent_to_check_programwork$', views.sent_to_check_programwork, name='sent_to_check_programwork'),
    re_path(r'^program_work_form_re_sent$', views.program_work_form_re_sent, name='program_work_form_re_sent'),

    re_path(r'^history_program_work/(?P<id>\d+)/$', views.history_program_work, name='history_program_work'),
    re_path(r'^history_polevoy_checking/(?P<id>\d+)/$', views.history_polevoy_checking, name='history_polevoy_checking'),
    re_path(r'^history_komeral_checking/(?P<id>\d+)/$', views.history_komeral_checking, name='history_komeral_checking'),
    re_path(r'^history_report/(?P<id>\d+)/$', views.history_report, name='history_report'),
    ...
    re_path(r'^status_work/(?P<id>\d+)/$', views.status_work, name='status_work'),
